...
const steps = [
  ...
  },
  {
    ...
    tail: "so related research papers feel easier to scan, compare, and revisit.",
    note: "Categorized browsing helps when users want to discover research papers within a field instead of relying on a single keyword search.",
  },
  {
    step: "04",
