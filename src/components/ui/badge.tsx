  ...
  'inline-flex items-center whitespace-nowrap justify-center border border-transparent font-medium focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 [&_svg]:-ms-px [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        curriculum_implementation_division: 'bg-purple-100 text-purple-700',
        school_governance_and_operations_division: 'bg-pink-100 text-pink-700',
        personnel_hr: 'bg-green-100 text-green-700',
        records_management: 'bg-indigo-100 text-indigo-700',
        asset_management: 'bg-yellow-100 text-yellow-700',
        cash_management: 'bg-orange-100 text-orange-700',
        ict: 'bg-sky-100 text-sky-700',
        legal_school_titling: 'bg-rose-100 text-rose-700',
        finance: 'bg-emerald-100 text-emerald-700',
        general_services_unit: 'bg-gray-200 text-gray-800',
        prime_hr: 'bg-lime-100 text-lime-700',
        quality_management_system: 'bg-fuchsia-100 text-fuchsia-700',
      },
      appearance: {
        default: '',
        light: '',
