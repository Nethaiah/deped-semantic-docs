    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg border border-gray-200 px-8 py-10 sm:px-10 sm:py-12 text-center">
        ...
        <div className="space-y-4 w-full flex flex-col items-center">
          <button
            onClick={() => reset()}
            className="w-full cursor-pointer rounded-lg bg-[#087830] px-4 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-[#065a24] hover:shadow-md focus:outline-none focus:ring-4 focus:ring-[#087830]/30"
          >
            Try Again
          </button>
          ...
          <div className="pt-4 flex items-center justify-center w-full">
            <Link
              href="/login"
              className="text-sm font-semibold text-[#087830] hover:text-[#065a24] transition-colors"
            >
