...
export default async function AdminDocuments({ name }: Admin ) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 p-6">
      {/* Header Section */}
      <div className="bg-white rounded-lg shadow-md border border-gray-200 px-8 py-15 mb-6 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-gray-400/10 to-gray-500/10 rounded-full blur-3xl"></div>
              ...
              {monthlyData.map((data, index) => (
                ...
                >
                  <div className="w-full flex flex-col items-center justify-end h-40 relative">
                    ...
                    {/* Bar */}
                    <div
                      className="w-full bg-[#008c8b] rounded-t-lg transition-all duration-500 hover:bg-gray-600 relative group"
                      style={{
